...
if (global.menuno == 5)
{
    ...
    if (global.submenu == 35)
    {
        ...
        if (os_type == os_ps4 || os_type == os_switch)
        {
            ...
            var buttonYPos = (os_type == os_switch ? ((yy + 100) + _yOffset) : ((yy + 95) + _yOffset))
            ...
            draw_text((xx + 435), ((yy + 95) + _yOffset), string_hash_to_newline(scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_115_0")))
