...
namespace UndertaleModTool
{
    ...
    public partial class UndertaleEmbeddedImageEditor : DataUserControl
    {
        ...
        public UndertaleEmbeddedImageEditor()
        {
            ...
            ((Label)this.FindName("ImagesObjectLabel")).Content = ((Label)mainWindow.FindName("ObjectLabel")).Content;
        }
        private void UndertaleImagesEditor_Unloaded(object sender, RoutedEventArgs e)
        {
        ...
        private void UserControl_DataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            ((Label)this.FindName("ImagesObjectLabel")).Content = idString;
