...
namespace UndertaleModTool
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged, IScriptInterface
    {
        public void ReplaceTempWithMain(bool imAnExpertBtw = false)
        {
            ...
            {
                OwnedMessageBox.Show("ReplaceTempWithMain error! Send this to Grossley#2869 and make an issue on Github\n" + exc.ToString());
            }
        }
        public void ReplaceMainWithTemp(bool imAnExpertBtw = false)
        {
            ...
            {
                OwnedMessageBox.Show("ReplaceMainWithTemp error! Send this to Grossley#2869 and make an issue on Github\n" + exc.ToString());
            }
        }
        public void ReplaceTempWithCorrections(bool imAnExpertBtw = false)
        {
            ...
            {
                OwnedMessageBox.Show("ReplaceCorrectionsWithTemp error! Send this to Grossley#2869 and make an issue on Github\n" + exc.ToString());
            }
        }
