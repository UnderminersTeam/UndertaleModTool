...
namespace UndertaleModLib.Models
{
    public class UndertaleTags : UndertaleObject
    {
        ...
        public int GetAssetTagID(UndertaleData data, UndertaleSprite res)
        {
            return ((int)ResourceType.Sprite << 24) | (data.Sprites.IndexOf(res) & 0xFFFFFF);
        }

        public int GetAssetTagID(UndertaleData data, UndertaleSound res)
        {
            return ((int)ResourceType.Sound << 24) | (data.Sounds.IndexOf(res) & 0xFFFFFF);
        }

        public int GetAssetTagID(UndertaleData data, UndertaleRoom res)
        {
            return ((int)ResourceType.Room << 24) | (data.Rooms.IndexOf(res) & 0xFFFFFF);
        }

        public int GetAssetTagID(UndertaleData data, UndertalePath res)
        {
            return ((int)ResourceType.Path << 24) | (data.Paths.IndexOf(res) & 0xFFFFFF);
        }

        public int GetAssetTagID(UndertaleData data, UndertaleScript res)
        {
        ...
        public int GetAssetTagID(UndertaleData data, UndertaleFont res)
        {
            return ((int)ResourceType.Font << 24) | (data.Fonts.IndexOf(res) & 0xFFFFFF);
        }

        public int GetAssetTagID(UndertaleData data, UndertaleTimeline res)
        {
            return ((int)ResourceType.Timeline << 24) | (data.Timelines.IndexOf(res) & 0xFFFFFF);
        }

        public int GetAssetTagID(UndertaleData data, UndertaleBackground res)
        {
            return ((int)ResourceType.Background << 24) | (data.Backgrounds.IndexOf(res) & 0xFFFFFF);
        }

        public int GetAssetTagID(UndertaleData data, UndertaleShader res)
        {
            return ((int)ResourceType.Shader << 24) | (data.Shaders.IndexOf(res) & 0xFFFFFF);
        }

        public int GetAssetTagID(UndertaleData data, UndertaleSequence res)
        {
            return ((int)ResourceType.Sequence << 24) | (data.Sequences.IndexOf(res) & 0xFFFFFF);
        }

        public int GetAssetTagID(UndertaleData data, UndertaleAnimationCurve res)
        {
